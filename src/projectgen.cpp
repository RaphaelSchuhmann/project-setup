...
void generateFiles(std::string* prefs) {
  ...
  if (prefs[4] == "n") {
    generateFile("/usr/local/share/pset/templates/CMakeListsTemplate.txt", dir, "CMakeLists.txt", prefs);
  }

  if (prefs[2] == "c++") {
    generateFile("/usr/local/share/pset/templates/mainCpp.txt", dir + "src/", "main.cpp");
    generateFile("/usr/local/share/pset/templates/gitignoreCpp.txt", dir, ".gitignore");
  } else if (prefs[2] == "c") {
    generateFile("/usr/local/share/pset/templates/mainC.txt", dir + "src/", "main.c");
    generateFile("/usr/local/share/pset/templates/gitignoreC.txt", dir, ".gitignore");
  } else {
